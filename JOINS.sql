-- ====================================================================
-- LISTA 01: MODELAGEM E JOINS
-- Disciplina: Banco de Dados II | Prof. Wuldson Franco
-- Desenvolvido por: Alyere
-- ====================================================================

-- Questão 1: Pets e seus donos (Utilizando INNER JOIN e DISTINCT para evitar repetições)
SELECT DISTINCT
...
-- Questão 2: Relatório Completo de Vendas (Utilizando múltiplos JOINs)
SELECT DISTINCT
    c.nome AS cliente,
    v.data_venda,
    pr.nome AS produto,
...
-- Questão 3: Compras por Cliente (Utilizando LEFT JOIN e COALESCE)
SELECT 
    c.nome AS cliente,
